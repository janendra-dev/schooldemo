...
from schoolapp.models import Students, Subjects, CustomUser, Attendance, AttendanceReport, \
 LeaveReportStudent, FeedBackStudent,CustomUser,Courses,SessionYear, NotificationStudent, StudentResult
 # , OnlineClassRoomx
...
def student_home(request):
    ...
    # session_obj=SessionYear.object.get(id=student_obj.session_year_id.id)
