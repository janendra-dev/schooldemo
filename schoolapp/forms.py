...
from schoolapp.models import Courses, SessionYear, Subjects, Students
...
class AddStudentForm(forms.Form):
    ...
    session_list=[]
    sessions=SessionYear.object.all()
    try:
        for session in sessions:
            small_session=(session.id,str(session.session_start_year)+"To"+
