...
from schoolapp.models import Subjects,SessionYear,Students,Attendance,AttendanceReport,\
Staffs,LeaveReportStaff,FeedBackStaffs,CustomUser,Courses,NotificationStaffs,StudentResult
...
def staff_take_attendance(request):
	subjects=Subjects.objects.filter(staff_id=request.user.id)
	session_years=SessionYear.object.all()
...
def save_attendance_data(request):
    ...
    # print(student_ids,subject_id,attendance_date,session_year_id)
    subject_model=Subjects.objects.get(id=subject_id)
    session_model=SessionYear.object.get(id=session_year_id)
    # print(subject_model,session_model)
    json_sstudent=json.loads(student_ids) #dict object
...
@csrf_exempt #JsonResponse for ajax to get attendanc-dates
def get_attendance_dates(request):
    ...
    for attendance_single in attendance:
        ...
        attendance_obj.append(data) #appending dict to list

    return JsonResponse(json.dumps(attendance_obj),safe=False)

@csrf_exempt #JsonResponse for ajax to get attendant student
...
def staff_feedback_save(request):
    if request.method !='POST':
        ...
        try:
            ...
            feedback.save()
            messages.success(request,"successfully sent feeback ")
            return HttpResponseRedirect(reverse(("staff_feedback")))
        except:
            messages.error(request,"Fail to sent feeback")
            return HttpResponseRedirect(reverse(("staff_feedback")))    
